...
const NgoDashboard = () => {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      // Refresh token so backend never sees an expired one
  ...
  if (!authReady) {
    return <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100vh", fontSize: "15px", color: "#64748b" }}>Loading dashboard...</div>;
  }
